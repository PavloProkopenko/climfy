export const ua = {
  ...
  onboarding: {
    ...
    activityDescriptions: {
      sedentary: 'Майже без фізичних навантажень, переважно сидяча робота',
      light: 'Легкі прогулянки або тренування 1–3 рази на тиждень',
      active: 'Помірні тренування 3–5 разів на тиждень',
      athletic: 'Інтенсивні тренування 6–7 разів на тиждень',
    },
    ...
    coldSensitivityDescriptions: {
      cold_sensitive: 'Вам легко холодно, навіть у помірну погоду',
      neutral: 'Ви комфортно почуваєтесь при більшості температур',
      warm_tolerant: 'Вам рідко буває холодно, навіть при низьких температурах',
    },
    bio: 'Про вас',
    bioPlaceholder:
