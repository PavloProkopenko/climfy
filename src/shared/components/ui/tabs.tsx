  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'data-[state=active]:border-brand data-[state=active]:bg-brand/10 data-[state=active]:text-brand data-[state=active]:font-medium',
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn(
        'flex-1 outline-none data-[state=active]:animate-in data-[state=active]:fade-in-0 data-[state=active]:slide-in-from-bottom-2 data-[state=active]:duration-200',
        className,
      )}
      {...props}
    />
